...
const DashboardSideBar = ({ isOpen, onClose }) => {
  ...
  <aside>
    <div class="flex w-[150px] flex-col shadow-xl">
      <nav class="flex-1 divide-y-2">
        <ul class="flex flex-col gap-y-2">
          <li>
            <a href="/">
              <div class="flex cursor-pointer items-center gap-2 px-3 py-3 hover:bg-green-700 hover:text-white">
