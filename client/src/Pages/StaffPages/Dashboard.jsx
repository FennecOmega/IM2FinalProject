    ...
    <main class="p-6 sm:p-10 space-y-6">
      <div class="flex flex-col space-y-6 md:space-y-0 md:flex-row justify-between">
        <div class="mr-6">
          ...
          <h2 class="text-gray-600 ml-0.5">Banana Cupcake Employee Dashboard</h2>
        </div>
      </div>
  ...
  <section class="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
      ...
      <section class="grid md:grid-cols-2 xl:grid-cols-4 xl:grid-rows-3 xl:grid-flow-col gap-6">
        <div class="flex flex-col md:col-span-2 md:row-span-2 bg-white shadow rounded-lg">
          <div class="px-6 py-5 font-semibold border-b border-gray-100">Supplier and Staff Team Information</div>
          <div class="p-4 flex-grow">

          <div className="flex items-center pt-2">
          <img src="https://cdn.discordapp.com/embed/avatars/1.png" class="cursor-pointer w-10 h-10 rounded-3xl mr-3 mt-2"/>
            <span class="block text-2xl font-bold">Philip Isidro Joseph Go</span>
          </div>
          <span class="block text-gray-500 pl-10 ml-3">Staff</span>
         
          <div className="flex items-center pt-2">
          <img src="https://cdn.discordapp.com/embed/avatars/3.png" class="cursor-pointer w-10 h-10 rounded-3xl mr-3 mt-2"/>
            <span class="block text-2xl font-bold">Kenneth John Lao Cantillas</span>
          </div>
          <span class="block text-gray-500 pl-10 ml-3">Staff</span>

          <div className="flex items-center pt-2">
          <img src="https://cdn.discordapp.com/embed/avatars/2.png" class="cursor-pointer w-10 h-10 rounded-3xl mr-3 mt-2"/>
            <span class="block text-2xl font-bold">Matthea Trina Ornopia Borromeo</span>
          </div>
          <span class="block text-gray-500 pl-10 ml-3">Supplier</span>

          <div className="flex items-center pt-2">
          <img src="https://cdn.discordapp.com/embed/avatars/4.png" class="cursor-pointer w-10 h-10 rounded-3xl mr-3 mt-2"/>
        ...
        <div class="flex flex-col row-span-2 bg-white shadow rounded-lg">
          <div class="px-6 py-5 font-semibold border-b border-gray-100">Sales month by month</div>
          <div class="p-4 flex-grow">
          ...
          <div class="flex flex-col row-span-2 bg-white shadow rounded-lg">
          <div class="px-6 py-5 font-semibold border-b border-gray-100">Expenses on inventory</div>
          <div class="p-4 flex-grow">
